...
def main(reads_1, reference, reference_index, read_group_sample, loglevel,
    ...
    advanced_samtools_sort_options=None, advanced_picard_markdups_options=None,
    ...
    dups_metrics_file = "out/download_quality_metrics/{0}.markdups.metrics.txt".format(read_group_sample)
